...
class ChallengeAuthorityOperation(Base):
    ...
    __tablename__ = 'dpds_op_challenge_authorities'
    __table_args__ = (
        PrimaryKeyConstraint('block_num', 'transaction_num', 'operation_num'),
        ForeignKeyConstraint(['challenger'], ['dpds_meta_accounts.name'],
            deferrable=True, initially='DEFERRED', use_alter=True),
        ForeignKeyConstraint(['challenged'], ['dpds_meta_accounts.name'],
            deferrable=True, initially='DEFERRED', use_alter=True),)
    ...
    challenger = Column(String(16)) # dpay_type:account_name_type
    challenged = Column(String(16)) # dpay_type:account_name_type
    require_owner = Column(Boolean) # dpay_type:bool
    operation_type = Column(operation_types_enum,nullable=False,index=True,default='challenge_authority')
