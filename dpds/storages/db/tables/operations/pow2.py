...
class Pow2Operation(Base):
    ...
    ======================
    {
      "props": {
        ...
        "account_creation_fee": "0.001 BEX",
    ...
    work = Column(JSONB) # dpay_type:dpay::protocol::pow2_work
    new_owner_key = Column(String(60)) # dpay_type:optional< public_key_type>
    ...
    _fields = dict(
        work=lambda x:json_string_field(x.get('work')), # dpay_type:dpay::protocol::pow2_work
