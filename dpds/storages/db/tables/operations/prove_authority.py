...
class ProveAuthorityOperation(Base):
    ...
    __tablename__ = 'dpds_op_prove_authorities'
    __table_args__ = (
    ...
    operation_type = Column(operation_types_enum,nullable=False,index=True,default='prove_authority')
    ...
    _account_fields = frozenset(['challenged',])
