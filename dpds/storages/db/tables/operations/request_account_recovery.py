...
class RequestAccountRecoveryOperation(Base):
    ...
    ======================
    {
      "new_owner_authority": {
        "key_auths": [
          [
            "DWB6LYxj96zdypHYqgDdD6Nyh2NxerN3P1Mp3ddNm7gci63nfrSuZ",
            1
          ]
        ],
        "account_auths": [],
    ...
    __tablename__ = 'dpds_op_request_account_recoveries'
    __table_args__ = (
        PrimaryKeyConstraint('block_num', 'transaction_num', 'operation_num'),
        ForeignKeyConstraint(['recovery_account'], ['dpds_meta_accounts.name'],
    ...
    recovery_account = Column(String(16)) # dpay_type:account_name_type
