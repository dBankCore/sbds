...
class AccountUpdateOperation(Base):
    ...
    __tablename__ = 'dpds_op_account_updates'
    __table_args__ = (
    ...
    owner = Column(JSONB) # dpay_type:optional< authority>
    active = Column(JSONB) # dpay_type:optional< authority>
    posting = Column(JSONB) # dpay_type:optional< authority>
    ...
    _fields = dict(
        owner=lambda x:json_string_field(x.get('owner')), # dpay_type:optional< authority>
