...
class CommentBenefactorRewardVirtualOperation(Base):
    ...
    __tablename__ = 'dpds_op_virtual_comment_benefactor_rewards'
    __table_args__ = (

        ForeignKeyConstraint(['benefactor'], ['dpds_meta_accounts.name'],
    ...
    benefactor = Column(String(16)) # dpay_type:account_name_type
    ...
    operation_type = Column(operation_types_enum,nullable=False,index=True,default='comment_benefactor_reward')
