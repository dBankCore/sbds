...
class HardforkVirtualOperation(Base):
    ...
    __tablename__ = 'dpds_op_virtual_hardforks'
    __table_args__ = (
        )
    ...
    hardfork_id = Column(Numeric) # dpay_type:uint32_t
    operation_type = Column(operation_types_enum,nullable=False,index=True,default='hardfork')
