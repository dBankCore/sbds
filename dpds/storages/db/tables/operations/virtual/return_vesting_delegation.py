...
class ReturnVestingDelegationVirtualOperation(Base):
    ...
    __tablename__ = 'dpds_op_virtual_return_vesting_delegations'
    __table_args__ = (
    ...
    operation_type = Column(operation_types_enum,nullable=False,index=True,default='return_vesting_delegation')
