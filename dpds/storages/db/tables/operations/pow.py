...
class PowOperation(Base):
    ...
    ======================
    {
      ...
      "work": {
        ...
        "worker": "DWB65wH1LZ7BfSHcK69SShnqCAH5xdoSZpGkUjmzHJ5GCuxEK9V5G",
    ...
    __tablename__ = 'dpds_op_pows'
    __table_args__ = (
        PrimaryKeyConstraint('block_num', 'transaction_num', 'operation_num'),
        ForeignKeyConstraint(['worker_account'], ['dpds_meta_accounts.name'],
    ...
    worker_account = Column(String(16)) # dpay_type:account_name_type
    block_id = Column(String(40)) # dpay_type:block_id_type
    nonce = Column(Numeric) # dpay_type:uint64_t
    work = Column(JSONB) # dpay_type:pow
    ...
    _fields = dict(
        work=lambda x:json_string_field(x.get('work')), # dpay_type:pow
        props=lambda x:json_string_field(x.get('props')), # dpay_type:chain_properties
