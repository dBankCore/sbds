...
class LimitOrderCreateOperation(Base):
    """
    ...
    ======================
    {
      ...
      "fill_or_kill": false,
      "amount_to_sell": "9.950 BEX",
      "owner": "linouxis9",
      "orderid": 10,
      "min_to_receive": "3.500 BBD"
    }

    """

    __tablename__ = 'dpds_op_limit_order_creates'
    __table_args__ = (
    ...
    min_to_receive = Column(Numeric(20,6), nullable=False) # dpay_type:asset
    min_to_receive_symbol = Column(String(5)) # dpay_type:asset
    ...
    _fields = dict(
        ...
        min_to_receive=lambda x: amount_field(x.get('min_to_receive'), num_func=float), # dpay_type:asset
        min_to_receive_symbol=lambda x: amount_symbol_field(x.get('min_to_receive')), # dpay_type:asset
