...
class WitnessUpdateOperation(Base):
    ...
    block_signing_key = Column(String(60), nullable=False) # dpay_type:public_key_type
    ...
    operation_type = Column(operation_types_enum,nullable=False,index=True,default='witness_update')
