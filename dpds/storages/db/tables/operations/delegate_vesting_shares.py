...
class DelegateVestingSharesOperation(Base):
    ...
    __tablename__ = 'dpds_op_delegate_vesting_share'
    __table_args__ = (
        PrimaryKeyConstraint('block_num', 'transaction_num', 'operation_num'),
        ForeignKeyConstraint(['delegator'], ['dpds_meta_accounts.name'],
            deferrable=True, initially='DEFERRED', use_alter=True),
        ForeignKeyConstraint(['delegatee'], ['dpds_meta_accounts.name'],
            deferrable=True, initially='DEFERRED', use_alter=True),)
    ...
    delegator = Column(String(16)) # dpay_type:account_name_type
    delegatee = Column(String(16)) # dpay_type:account_name_type
