...
from dpds.storages.db.tables.core import prepare_raw_block
...
class Block(Base, UniqueMixin):
                ...
                "operations": [
                    [
                        "comment",
                        {
                            ...
                            "permlink": "re-einsteinpotsdam-tutorial-for-other-shop-owners-how-to-accept-bex-and-bex-usd-payments-setup-time-under-2-minutes-android-20160811t215904898z",
                            "parent_permlink": "tutorial-for-other-shop-owners-how-to-accept-bex-and-bex-usd-payments-setup-time-under-2-minutes-android",
                            "json_metadata": "{\"tags\":[\"dpay\"]}"
                        }
                    ]
                ],
                    ...
                    [
                        "witness_update",
                        {
                            ...
                            "props": {
                                ...
                                "account_creation_fee": "1.000 BEX",
                                "bbd_interest_rate": 1000
                            },
                            "block_signing_key": "DWB5b3wkzd5cPuW8tYbHpsM6qo26R5eympAQsBaoEfeMDxxUCLvsY",
                            "fee": "0.000 BEX",
                ...
                "operations": [
                    [
                        "account_update",
                        {
                            ...
                            "memo_key": "DWB7myUzFgMrc5w2jRc3LH2cTwcs96q74Kj6GJ3DyKHyrHFPDP96N",
                            "active": {
                                "key_auths": [
                                    [
                                        "DWB5sP9GUuExPzK35F1MLjN2dTY7fqqP7dSpMWqnzCoU3je64gm6q",
                                        2
                                    ],
                                    [
                                        "DWB7t97bmNzbVruhH3yGQ7yFR58UJyPTb7Jh6ugmPfH1zqzJpngQH",
                                        1
                                    ]
                                ],
                                "weight_threshold": 0,
    ...
    __tablename__ = 'dpds_core_blocks'
    ...
    witness = Column(String(16), ForeignKey("dpds_meta_accounts.name")
                     )  # dpay_type:{account_name_type}'
    ...
    def to_json(self):
        return dpds.dpds_json.dumps(self.to_dict())
    ...
    def get_or_create_from_raw_block(cls, raw_block, session=None):
        ...
        Returns:
            dpds.storages.db.tables.core.Block:
        """
